...
public class ExcelDataTest {
    ...
    public Object[][] noNameData() {
        ...
        ExcelDataUtil e = new ExcelDataUtil("ExcelDataTest" , "testNoNameLogin");
        return e.getExcelData();
    }
    /**
     * 测试登录没有输入用户名
     */
    @Test(dataProvider = "noNameTip",priority = 1, enabled = true, groups = "smoke")
    public void testLogin(HashMap<String, String> data) throws IOException {
        ...
        String data_response = jsonResponse.get("data").toString();
